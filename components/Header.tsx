...
export function Header() {
  return <header className="siteHeader"><div className="container navWrap">
    ...
    <div className="headerActions"><span className="status"><i/>SYS.OK</span><a className="button small" href="/app">Acessar sistema</a><a className="iconButton" href="/app" aria-label="Acessar sistema"><Icon name="user"/></a></div>
  </div></header>;
}
