...
export function Header() {
  return <header className="siteHeader"><div className="container navWrap">
    ...
    <div className="headerActions"><span className="status"><i/>SYS.OK</span><a className="button small" href="/login">Entrar</a><a className="iconButton" href="/login" aria-label="Entrar"><Icon name="user"/></a></div>
  </div></header>;
}
