...
export function Hero() {
  return <section className="hero blueprint" id="top"><div className="scan"/><div className="container heroGrid"><div className="heroCopy">
    ...
    <div className="actions"><a className="button" href="/criar-conta">Criar workspace <Icon name="arrow"/></a><a className="button secondary" href="/login"><Icon name="user"/> Já tenho conta</a></div>
