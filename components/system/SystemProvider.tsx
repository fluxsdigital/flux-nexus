...
type Store = { companies:Company[]; equipment:Equipment[]; inspections:Inspection[]; companyFilter:string; setCompanyFilter:(v:string)=>void; addCompany:(v:Omit<Company,"id">)=>Promise<void>; addEquipment:(v:Omit<Equipment,"id">)=>Promise<void>; addInspection:(v:Omit<Inspection,"id">,signatureData?:string)=>Promise<string>; completeInspection:(id:string,signatureData?:string)=>Promise<void> };
