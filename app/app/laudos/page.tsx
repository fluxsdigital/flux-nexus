...
type ApiInspection = {
  ...
  evidence:{id:string;type:string;title:string;description:string;fileName:string;mimeType:string;size:number;sha256:string;capturedAt:string|null;measurementKey?:string|null;dataUrl?:string}[];
